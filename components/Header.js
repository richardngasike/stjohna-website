    ...
    <header className={isScrolled ? 'hidden' : ''}>
        ...
        <div className="container">
          <div className="contact-info">
            ...
            <div className="contact-details">
              ...
              <span>✉️ <a href="mailto:stjohnstrainingcollege@gmail.com"> click to email Us</a></span>
            </div>
          </div>
          <div className="social-media">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
              <svg className="social-icon" viewBox="0 0 24 24" fill="#000000ff" xmlns="http://www.w3.org/2000/svg">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <svg className="social-icon" viewBox="0 0 24 24" fill="#2f00ffff" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://whatsapp.com" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
              <svg className="social-icon" viewBox="0 0 24 24" fill="#00ff15ff" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container">
        <div className="header-content">
          ...
          <nav className={`nav ${isMobileMenuOpen ? 'open' : ''}`} aria-label="Main navigation">
            ...
            <div className="nav-item">
              <Link href="/coursesandprograms">COURSES</Link>
            </div>
            <div className="nav-item">
              <button
            ...
            <div className="nav-item">
              ...
              <div className={`dropdown ${openDropdown === 6 ? 'open' : ''}`}>
                <Link href="/library">📚 Driving School</Link>
      ...
      <style jsx>{`
        ...
        .nav {
          ...
          background: green;
          padding: 1rem;
          box-shadow: 0 -2px 5px rgba(238, 255, 0, 0.1);
          z-index: 3100;
          transform: translateY(100%);
          transition: transform 0.3s ease-in-out;
        }
        ...
        /* Desktop navbar styles (min-width: 769px) */
